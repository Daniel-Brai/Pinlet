...
SECRET_KEY = 'django-insecure-1vcz@zi5-xd$@k$hn^07vybjqb12031yl@9lh!ukw76+rv1bi3'
...
# PASSWORD_RESET_CONFIRM_URL = 'account:password_reset_confirm'

# PASSWORD_RESET_COMPLETE_URL = 'account:password_reset_complete'
